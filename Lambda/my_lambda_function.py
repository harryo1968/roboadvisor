...
> **Hint:** Be creative while coding your solution, you can have all the code on the `recommend_portfolio()` function, or you can split the functionality across
different functions, put your Python coding skills in action!

5. Once you finish coding your Lambda function, test it using the sample test events provided for this Challenge.

6. After successfully testing your code, open the Amazon Lex Console and navigate to the `recommendPortfolio` bot configuration, integrate your new Lambda 
function by selecting it in the “Lambda initialization and validation” and “Fulfillment” sections.
    ...
    if age is not None:
        ...
        if age not in age_range:
            return build_validation_result(
                False,
                "age",
                "The age should be younger than 65 to investing for retirement. "
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "That's not enough money. lol "
                "Investment amount should be at least $5000. Please enter another amount.",
            )
...
def recommend_portfolio(intent_request):
    ...
    if risk_level.lower() == "none":
        risk_resp = "100% bonds (AGG), 0% equities (SPY)"
    elif risk_level.lower() == 'low':
        risk_resp = "60% bonds (AGG), 40% equities (SPY)"
    elif risk_level.lower() == 'medium':
        risk_resp = "40% bonds (AGG), 60% equities (SPY)"
    elif risk_level.lower() == 'high':
        risk_resp = "20% bonds (AGG), 80% equities (SPY)"
    else:
        risk_resp = "Please pick: None, Low, Medium, or High"
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thanks. With a {} risk on your retirement investment;
            Your recomendation is: {}.
            """.format(
                risk_level, risk_resp
            ),
        },
    )
